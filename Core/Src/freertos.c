...
/* Definitions for dbug_info */
osThreadId_t dbug_infoHandle;
const osThreadAttr_t dbug_info_attributes = {
  .name = "dbug_info",
  .stack_size = 1000 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  foc_taskHandle = osThreadNew(foc_task_fun, NULL, &foc_task_attributes);

  /* creation of dbug_info */
  dbug_infoHandle = osThreadNew(dbug_info_fun, NULL, &dbug_info_attributes);
...
__weak void foc_task_fun(void *argument)
{
...
__weak void dbug_info_fun(void *argument)
{
